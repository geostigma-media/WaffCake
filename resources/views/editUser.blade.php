        ...
        <div class="card-body">
          ...
          <form action="{{route('updateUser',$user->id)}}" method="post">
            ...
            <div class="form-group row">
              ...
              <div class="col-md-12">
                <input required id="name" value="{{$user->name}}" type="text"
            ...
            <div class="form-group row">
              ...
              <div class="col-md-12">
                <input required id="lastname" value="{{$user->lastname}}" type="text"
            ...
            <div class="form-group row">
              ...
              <div class="col-md-12">
                <input required id="numIndentificate" value="{{$user->numIndentificate}}" type="text"
            ...
            <div class="form-group row">
              ...
              <div class="col-md-12">
                <input required id="mobile" type="text" value="{{$user->mobile}}"
