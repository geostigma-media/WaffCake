...
<div class="container"> <br>
  ...
  <div class="row justify-content-center">
    <div class="col-md-8">
      ...
      <p class="textregister">¡Regístrate en 1 solo paso y disfruta de la delicia del waffle con descuentos especiales!</p>
      <div class="card">
        <div class="card-header">
          <p><b>Tarjeta cliente fiel</b>, recibirás 5%, 10% y hasta el 50% de descuento al acumular compras.
            Y Además después de inscribirte, podrás ganar hasta el 5% de descuento solo con recomendarnos en <b>“pasa la voz waffcake”</b> cada vez que refieras a un amigo y el haga efectiva una compra, tu recibirás el 5% y tu referido el 2% de descuento.</p>
          ...
          <form method="POST" action="{{ route('register') }}">
            ...
            <div class="form-group row">
              ...
              <div class="col-md-6">
                ...
                @error('lastname') <span class="invalid-feedback" role="alert"> <strong>{{ $message }}</strong> </span> @enderror </div>
            </div>
            <div class="form-group row">
              ...
              <div class="col-md-6">
                ...
                @error('numIndentificate') <span class="invalid-feedback" role="alert"> <strong>{{ $message }}</strong> </span> @enderror </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
              ...
              <div class="col-md-6">
                ...
                @error('mobile') <span class="invalid-feedback" role="alert"> <strong>{{ $message }}</strong> </span> @enderror </div>
            </div>
            <div class="col-12">
              <div class="custom-control custom-checkbox">
                <input type="checkbox" name="terminos" require class="custom-control-input" id="customCheck1">
                <label class="custom-control-label" for="customCheck1"> He leído y acepto términos y condiciones – <a href="https://www.waffcake.com/terminos_condiciones.html" target="_blank"> Ver aquí </a> </label>
              </div>
            </div>
            <hr>
